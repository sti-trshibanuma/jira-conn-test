...
// Module      : PY
// Function    : 04
// File Name   : BA_HR_PY_04_R14.cs
// 機能名      : HR_PY_04_R14 賞与支給明細書（ヒサゴ）
// Version     : 3.2.0
...
// 管理番号 B17038 To
				...
				BL_HR_PY_04_R14 blHrPy04R14 = BL_HR_PY_04_R14.GetInstance();

				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPy04R14.Select(commonData, condition, false);
				}
...
// 管理番号K27228 To
				...
				{
					//帳票の定義設定
					Infocom.Allegro.HR.rpt.HR_PY_03_R06	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_03_R06();
...
//					rpt01.Run(false);
					...
					Allegro.Report.RptCache rc = new Allegro.Report.RptCache(reportID.Replace("(", "").Replace(")",""), commonData);
					// ディスクキャッシュプロパティの設定
