...
// 管理番号 B17038 To
				...
				BL_HR_PA_03_R01 blHrPa03R01 = BL_HR_PA_03_R01.GetInstance();
				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPa03R01.Select(commonData, condition, false);
				}
...
// 管理番号K27228 To
				...
				{
					//帳票の定義設定
					Infocom.Allegro.HR.rpt.HR_PA_03_R01	rpt01  = new Infocom.Allegro.HR.rpt.HR_PA_03_R01();
					// プロパティによるヘッダ情報の設定
					rpt01.commonData = commonData;
					rpt01.ReportID=args[2];
					rpt01.CompanyName =sCopyName;
// 管理番号K15531 From
//					rpt01.BaseDate = condition.DateResvYmdFrom.Substring(0,4) + "/" + condition.DateResvYmdFrom.Substring(4,2) + "/" + condition.DateResvYmdFrom.Substring(6,2);
					rpt01.BaseDate = condition.DateResvYmdFrom;
// 管理番号K15531 To
					//明細情報の設定
