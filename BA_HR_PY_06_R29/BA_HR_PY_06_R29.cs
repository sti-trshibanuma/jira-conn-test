...
// 管理番号 B17038 To
				...
				BL_HR_PY_06_R29 blHrPy06R29 = BL_HR_PY_06_R29.GetInstance();

				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPy06R29.Select(commonData, condition, false);
				}
...
// 管理番号K27228 To
				...
				{
					//帳票の定義設定
					Infocom.Allegro.HR.rpt.HR_PY_06_R29	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_06_R29();

					// プロパティによるヘッダ情報の設定
					rpt01.commonData = commonData;
					rpt01.ReportID = "(HR_PY_06_R29)";
