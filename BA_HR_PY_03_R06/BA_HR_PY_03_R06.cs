...
// 管理番号 B17038 To
				...
				BL_HR_PY_03_R06 blHrPy03R06 = BL_HR_PY_03_R06.GetInstance();
				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPy03R06.Select(commonData, condition, false);
				}
