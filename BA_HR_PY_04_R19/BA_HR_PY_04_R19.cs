...
// Module      : PY
// Function    : 04
// File Name   : BA_HR_PY_04_R19.cs
// 機能名      : HR_PY_04_R19 賞与台帳ワーク作成
// Version     : 3.2.0
...
// 管理番号 K17838 2007/03/01 給与関連帳票 新規追加 機能拡充
// 1.5.1 2007/06/30
...
// 管理番号 K17838 From
//				BL_HR_PY_04_R19 blHrPy04R19 = BL_HR_PY_04_R19.GetInstance();
				BL_HR_PY_04_R47 blHrpy04r47 = BL_HR_PY_04_R47.GetInstance();
// 管理番号 K17838 To
				...
				try
				{
					//データ取得
// 管理番号 K17838 From
//					detailDt = blHrPy04R19.Select(commonData, condition,false);
					detailDt = blHrpy04r47.Select(commonData, condition, false);
// 管理番号 K17838 To
				}
...
// 管理番号K27228 To
				...
				try
				{
					//帳票の定義設定
// 管理番号 K17838 From
//					Infocom.Allegro.HR.rpt.HR_PY_03_R10	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_03_R10();
					Infocom.Allegro.HR.rpt.HR_PY_04_R47	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_04_R47();
// 管理番号 K17838 To

					// プロパティによるヘッダ情報の設定
					rpt01.commonData = commonData;
// 管理番号 K17838 From
//					rpt01.ReportID = "(HR_PY_03_R10)";
					rpt01.ReportID = "(HR_PY_04_R47)";
// 管理番号 K17838 To
