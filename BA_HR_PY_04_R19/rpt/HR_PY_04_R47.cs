...
// Module      : PY
// Function    : 04
// File Name   : HR_PY_04_R47.cs
// 機能名      : HR_PY_04_R47 賞与台帳
// Version     : 3.2.0
...
{
	public class HR_PY_04_R47 : GrapeCity.ActiveReports.SectionReport
	{
		public HR_PY_04_R47()
		{
		...
		#region HR_PY_04_R47_ReportStart
		private void HR_PY_04_R47_ReportStart(object sender, System.EventArgs eArgs)
		{
			int i;
...
//			Amt9.OutputFormat = Format.Text;
//			Amt10.OutputFormat = Format.Text;
		}
		#endregion
...
//			if((EmpCode9.Text == null)||(EmpCode9.Text.Length == 0))
//			{
//				Amt9.Visible = false;
//			}
//			if((EmpCode10.Text == null)||(EmpCode10.Text.Length == 0))
//			{
//				Amt10.Visible = false;
//			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HR_PY_04_R47));
			...
			this.ReportIDText.Text = "(HR_PY_04_R47)";
			...
			this.PrintName.Style = "font-size: 14pt; text-align: center; ddo-char-set: 1; ddo-shrink-to-fit: none";
    ...
    "p; ddo-char-set: 128";
			...
			this.ReportStart += new System.EventHandler(this.HR_PY_04_R47_ReportStart);
