...
// Module      : PY
// Function    : 06
// File Name   : BA_HR_PY_06_R22.cs
// 機能名      : HR_PY_06_R22 給与所得源泉徴収票(専用)
// Version     : 3.2.0
// Last Update : 2023/03/31
// Copyright (c) 2004-2023 Grandit Corp. All Rights Reserved.
//
// 1.0.0 2004/04/01
// 管理番号K15531 2005/10/13 画面帳票出力順序
// 1.4.0 2005/10/31
// 管理番号 B17038 2006/02/02 大量印刷帳票(SQLコマンドのタイムアウト)
// 管理番号 K19695 2006/11/24 源泉徴収票(マイナスの支払金額対応)
// 1.4.2 2006/11/30
// 1.5.2 2007/10/31
...
// 管理番号 K23940 2011/11/01 平成２２年度税制改正対応
// 管理番号 B24365 2012/04/16 帳票出力時に不要なログが出力される不具合を修正
// 2.0.0 2012/10/31
// 管理番号 K24060 2012/11/14 平成２２年度税制改正対応（介護医療保険料控除）
// 2.2.0 2014/10/31
...
// 管理番号K26355 To
				condition.ExclusiveFlg = "1";	// 専用紙フラグ
// 管理番号 K23122 To
				try
				{
					//データ取得
// 管理番号K26024 From
//					detailDt = blHrPy06R21.Select(commonData, condition, false);
...
// 管理番号K27228 To
				...
				{
					//帳票の定義設定
					Infocom.Allegro.HR.rpt.HR_PY_03_R53	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_03_R53();

					// プロパティによるヘッダ情報の設定
					rpt01.commonData = commonData;
// 管理番号 B24365 From
//					rpt01.ReportID = "(HR_PY_03_R53)";
					rpt01.ReportID = "(HR_PY_06_R22)";
// 管理番号 B24365 To
					rpt01.CompanyName = sCopyName;
// 管理番号 K23940 From
					rpt01.YlyEdCalYear = detailDt.Rows[0]["YLY_ED_CAL_YEAR"].ToString();
// 管理番号 K23940 To
// 管理番号 B21040 From
					rpt01.WithHoldingSlipOutputFlg = blHrPy06R21.GetWithHoldingSlipOutputFlg(commonData);
// 管理番号 B21040 To
