...
// Module      : PY
// Function    : 03
// File Name   : HR_PY_03_R52.cs
// 機能名      : HR_PY_03_R52 退職者用源泉徴収票(A4)
// Version     : 3.2.0
...
{
	public class HR_PY_03_R52 : GrapeCity.ActiveReports.SectionReport
	{
		public HR_PY_03_R52()
		{
...
// 管理番号 K24565 To
		...
		private void HR_PY_03_R52_ReportStart(object sender, System.EventArgs eArgs)
		{
			//仮想プリンタの設定
...
// 管理番号 K20794 To
// 管理番号 K24565 From
			System.Data.DataRow[] dtR52 = ((System.Data.DataView)DataSource).Table.Select("[EMP_CODE] = '" + empCodeText.Text.Trim() + "'", "[EMP_CODE]");

			rpt.HR_PY_03_R99 rptR99 = new HR_PY_03_R99();
			//データソースを渡す
			rptR99.DataSource = dtR52;
...
//			PaymntPlCodeText.Text = EmpNum.ToString();
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HR_PY_03_R52));
    ...
    "いうえおかきくけこあいうえおかきくけこあいうえおかきくけこあいうえおかきくけこ";
			...
			this.ReportStart += new System.EventHandler(this.HR_PY_03_R52_ReportStart);
