...
// Module      : PY
// Function    : 06
// File Name   : BA_HR_PY_06_R21.cs
// 機能名      : HR_PY_06_R21 給与所得源泉徴収票(A4)
// Version     : 3.2.0
...
// 管理番号K27228 To
				...
				try
				{
					//帳票の定義設定
// 管理番号K26024 From
//					Infocom.Allegro.HR.rpt.HR_PY_03_R52	rpt01  = new Infocom.Allegro.HR.rpt.HR_PY_03_R52();
//
//					// プロパティによるヘッダ情報の設定
//					rpt01.commonData = commonData;
//// 管理番号 B24365 From
////					rpt01.ReportID = "(HR_PY_03_R52)";
//					rpt01.ReportID = "(HR_PY_06_R21)";
//// 管理番号 B24365 To
...
// 管理番号K27228 To
					...
					{
						Infocom.Allegro.HR.rpt.HR_PY_03_R62 rpt02 = new Infocom.Allegro.HR.rpt.HR_PY_03_R62();

						// プロパティによるヘッダ情報の設定
						rpt02.commonData = commonData;
						rpt02.ReportID = "(HR_PY_06_R21)";
