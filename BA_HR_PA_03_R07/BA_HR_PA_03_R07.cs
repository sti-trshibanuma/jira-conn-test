...
// 管理番号K27228 To
			...
			{			
// 管理番号K27228 From
//				//検索条件などがTabで区切られているため。Splitメソッドを使い各項目の条件に分類。
...
//				condition.PrgUpdateDatetime			= DateTime.Parse(sKey[52].Trim());		//プログラム更新日付
// 管理番号K15531 From
...
// 管理番号 B17038 To
				...
				BL_HR_PA_WkHrpa03r07_L blHrPaWkHrpa03r07 = BL_HR_PA_WkHrpa03r07_L.GetInstance();
				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPaWkHrpa03r07.AllRegist(commonData, condition, false);
				}
...
// 管理番号K27228 To
				...
				{
					//帳票の定義設定
					Infocom.Allegro.HR.rpt.HR_PA_03_R07	rpt01  = new Infocom.Allegro.HR.rpt.HR_PA_03_R07();
					// プロパティによるヘッダ情報の設定
