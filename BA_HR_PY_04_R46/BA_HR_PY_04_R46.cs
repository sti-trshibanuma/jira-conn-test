...
// Module      : PY
// Function    : 04
// File Name   : BA_HR_PY_04_R46.cs
// 機能名      : HR_PY_04_R46 賞与支給明細書（A4）
// Version     : 3.2.0
...
// 管理番号 B17038 To
				...
				BL_HR_PY_04_R46 blHrPy04R46 = BL_HR_PY_04_R46.GetInstance();

				DataTable detailDt = new DataTable(); 
				try
				{
					//データ取得
					detailDt = blHrPy04R46.Select(commonData, condition, false);
				}
